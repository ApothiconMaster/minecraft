...
def init():
    ...
    if z > 70:
        ...
        z = 70
    mc.setBlocks(x-15, -1, z-2, x+15, 50, z+112, block.AIR.id)
    mc.setBlocks(x-15, -1, z-2, x+15, -1, z+112, block.LAVA.id)
    mc.setBlocks(x-2, -1, z-2, x+2, -1, z+112, block.LAVA.id)
...
def makeHouse(mc, x, y, z):
    ...
    mc.setBlocks(x-1, y+3, z-3, x+2, y+3, z-3, block.LAVA_BLOCK.id)
    mc.setBlocks(x, y+4, z-3, x+1, y+4, z-3, block.LAVA_BLOCK.id)
    mc.setBlocks(x-1, y+3, z+3, x+2, y+3, z+3, block.LAVA_BLOCK.id)
    mc.setBlocks(x, y+4, z+3, x+1, y+4, z+3, block.LAVA_BLOCK.id)
    ...
    mc.setBlocks(x-3, y-1, z-1, x-4, y-1, z-1, block.LAVA.id)
    mc.setBlocks(x+4, y-1, z+1, x+5, y-1, z+1, block.LAVA.id)

    # Add Windows
    mc.setBlocks(x-2, y+1, z, x-2, y+1, z+1, block.LAVA.id)
    mc.setBlocks(x+3, y+1, z, x+3, y+1, z-1, block.LAVA.id)
    mc.setBlocks(x, y+1, z-3, x+1, y+1, z-3, block.LAVA.id)
    mc.setBlocks(x, y+1, z+3, x+1, y+1, z+3, block.LAVA.id)
